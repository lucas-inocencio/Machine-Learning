...
resposta = pd.read_csv('./conjunto_de_teste.csv')
...
dados['profissao_companheiro'] = dados['profissao_companheiro'].replace(
    r'^\s*$', np.NaN, regex=True)
resposta['profissao_companheiro'] = resposta['profissao_companheiro'].replace(
    r'^\s*$', np.NaN, regex=True)
dados['grau_instrucao_companheiro'] = dados['grau_instrucao_companheiro'].replace(
    r'^\s*$', np.NaN, regex=True)
resposta['grau_instrucao_companheiro'] = resposta['grau_instrucao_companheiro'].replace(
    r'^\s*$', np.NaN, regex=True)
...
dados['grau_instrucao_companheiro'] = dados['grau_instrucao_companheiro'].fillna(
    0)
resposta['profissao_companheiro'] = resposta['profissao_companheiro'].fillna(0)
resposta['grau_instrucao_companheiro'] = resposta['grau_instrucao_companheiro'].fillna(
    0)

dados = pd.get_dummies(dados, columns=['sexo', 'forma_envio_solicitacao'])
resposta = pd.get_dummies(
    resposta, columns=['sexo', 'forma_envio_solicitacao'])
